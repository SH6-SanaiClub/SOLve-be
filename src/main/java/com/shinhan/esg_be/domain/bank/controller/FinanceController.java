...
public class FinanceController {
    ...
    @GetMapping("/savings/{savingId}/history")
    public ResponseEntity<List<SavingHistoryResponse>> getSavingHistory(
            @PathVariable Long savingId
    ) {
        return ResponseEntity.ok(financeService.getSavingHistory(authContext.currentLoginId(), savingId));
    }
